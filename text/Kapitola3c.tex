...
\hline
$1$ vrstva & $0{,}00482$ & $0{,}092$ & bias signifikantní \\
$2$ vrstvy & $\approx 0$ & $0{,}053$ & bias nesignifikantní \\
$4$ vrstvy & $\approx 0$ & $0{,}028$ & bias nesignifikantní \\
$6$ vrstev & $\approx 0$ & $0{,}021$ & bias nesignifikantní \\
$8$ vrstev & $\approx 0$ & $0{,}022$ & bias nesignifikantní \\
\hline
\end{tabular}
\caption{Rozklad MSE vůči GP posterioru na $\text{bias}^2 + c/n$. Jednovrstvý model má jako jediný signifikantně nenulový $\text{bias}^2$; od dvou vrstev výše je ireducibilní chyba prakticky nulová a hloubka už jen snižuje varianční člen $c$.}
...
Za prvé, \textbf{jednovrstvý model má jako jediný signifikantně nenulový $\text{bias}^2 = 0{,}00482$}.
...
$$c_{1L} = 0{,}092 \;>\; c_{2L} = 0{,}053 \;>\; c_{4L} = 0{,}028 \;\approx\; c_{6L} = 0{,}021 \;\approx\; c_{8L} = 0{,}022.$$
Přidání vrstev tedy zrychluje konvergenci – hlubší model dosáhne téže přesnosti z~menšího kontextu.
Zlepšení se však sytí: mezi čtyřmi a osmi vrstvami se $c$ prakticky nemění.
Z~praktického hlediska to znamená, že přibližně čtyři vrstvy představují bod, za kterým už další prohlubování sítě nepřináší téměř žádný zisk v~přesnosti.
...
Rozklad chyby vysvětlil, \textbf{proč modelu jedna vrstva nestačí}: jednovrstvý model má jako jediný nenulový $\text{bias}^2 = 0{,}0048$, zatímco od dvou vrstev výše je ireducibilní chyba nulová a hloubka už jen snižuje varianční člen (do nasycení kolem čtyř vrstev).
