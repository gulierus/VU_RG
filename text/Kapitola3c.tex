...
Jednovrstvý model konvergoval již za $100$ epoch, dvou- a čtyřvrstvý byly trénovány $300$ epoch a nejhlubší šesti- a osmivrstvý $500$ epoch.
...
\hline
$0$ & $\mathbf{0{,}473}$ & $0{,}165$ & $0{,}075$ & $-0{,}065$ & $-0{,}094$ \\
$1$ & — & $\mathbf{0{,}813}$ & $\mathbf{0{,}885}$ & $0{,}660$ & $0{,}567$ \\
$2$ & — & — & $0{,}826$ & $\mathbf{0{,}814}$ & $\mathbf{0{,}872}$ \\
$3$ & — & — & $0{,}275$ & $0{,}663$ & $0{,}763$ \\
$4$ & — & — & — & $0{,}478$ & $0{,}771$ \\
$5$ & — & — & — & $0{,}316$ & $0{,}550$ \\
$6$ & — & — & — & — & $0{,}532$ \\
...
\textbf{Vrstva 0} má u~všech vícevrstvých modelů nejvyšší labelovou korelaci ($|\text{corr}| = 0{,}22$ až $0{,}47$) a zároveň nejnižší kernelovou korelaci ($-0{,}10$ až $0{,}17$); u~šesti- i osmivrstvého modelu je kernelová korelace první vrstvy dokonce mírně \textit{záporná}.
...
Jeho jediná vrstva má kernelovou korelaci $0{,}473$ – nejvyšší hodnotu v~celém sloupci vrstvy $0$ napříč modely.
...
\hline
$1$ vrstva & $(0,\, 1)$ & $0{,}00957$ & $\mathbf{44{,}9\times}$ \\
...
\hline
\end{tabular}
\caption{Kauzální důležitost hlav podle head-knockoutu, měřená \textbf{relativně} k~baseline chybě modelu. Uvedena je nejdůležitější hlava každého modelu, jeho baseline MSE vůči GP a maximální relativní zhoršení po vynulování té hlavy (např. $44{,}9\times$ znamená $44{,}9$násobek baseline chyby). Agregujeme \textbf{mediánem} přes $50$ instancí (robustní vůči vzácným patologickým instancím, které by průměr rozkolísaly), $n_{\text{ctx}} = 40$.}
...
V~absolutních číslech hluboké modely knockout „ustojí“ (zůstávají blízko GP), avšak \textbf{relativně k~vlastní baseline chybě} zhorší odebrání jediné hlavy predikci napříč všemi hloubkami o~$10$ až $25$ násobek – hlavy tedy \emph{nejsou} bezvýznamné, jen individuálně nekritické.
Jednovrstvý model je nejkřehčí ($44{,}9\times$): s~jedinou vrstvou nese každá z~jejích osmi hlav nezastupitelný díl celého výpočtu.
\par

Poznamenejme, že relativní zhoršení agregujeme \emph{mediánem} přes instance, nikoli průměrem.
Střední kvadratická chyba PFN vůči GP posterioru je totiž na typické instanci nepatrná (řádově $10^{-4}$), ale na několika málo patologických realizacích může být o~řády vyšší; průměr by tak byl zcela ovládnut těmito outliery a napříč modely by kolísal o~dva řády už při pouhé změně náhodného semínka. Medián tuto křehkost odstraňuje a dává stabilní, mezi modely srovnatelný obraz.
\par
...
\hline
$1$ vrstva & $0{,}00476$ & $0{,}097$ & bias signifikantní \\
$2$ vrstvy & $-0{,}00152$ & $0{,}068$ & bias nesignifikantní \\
$4$ vrstvy & $-0{,}00089$ & $0{,}035$ & bias nesignifikantní \\
$6$ vrstev & $-0{,}00076$ & $0{,}029$ & bias nesignifikantní \\
...
Za prvé, \textbf{jednovrstvý model má jako jediný signifikantně nenulový $\text{bias}^2 = 0{,}00476$}.
