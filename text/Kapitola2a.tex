...
PFN je tzv. \emph{encoder–only} architektura (tj. neobsahuje \emph{dekóder} blok, ale pouze \emph{enkóder} blok transformeru), na kterou je pak napojena softmax hlava, pro vyhodnocování výsledků ve tvaru pravděpodobností.
...
A tento princip se dobře prolíná s obecnou úlohou aproximace funkcí pomocí neuronových sítí, protože při jejich návrhu vždy musíme enkódovat apriorní znalosti o této funkce.
...
Po $6$ vrstvách embedding testovacího bodu obsahuje dostatečnou informaci k tomu, aby \emph{dekóder} z něj vyrobil prediktivní distribuci.
\par   
...
\subsection{Fáze 4 – Dekóder, převod embeddingu na logity.}
...
Logit v tomto případě je jenom surové číslo z poslední lineární vrstvy našeho \emph{dekóderu}.
