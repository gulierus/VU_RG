...
Aktuální verzi zdrojového kód PFN naleznete zde (\url{https://github.com/automl/PFNs}).
\par 


V předchozí sekci jsme již zmínili, že PFN je transformer, který se trénuje na obrovském množství synetických datasetů, které vzorkujeme z prioru.
...
V předchozí sekci jsme již drobně popsali, jak funguje trénink PFN, formálněji a mnohem podrobněji lze tento proces zapsat takto:
...
Evidentně pak můžeme dopočítat i všechny potřebné deskriptivní charakteristiky jako stření hodnotu, rozptyl atd.
...
Například Přesně tak je tomu u histogramového odhadu hustoty, kde se může diskretizovat vysokodimenzionální vstupní prostor.
