...
Müller ukazuje cca $200\times$ zrychlení proti Type II – MLE a přibližně $1\,000\times$ až $8\,000\times$ proti NUTS, navíc na rozdíl od NUTS, PFN neprovádí žádné optimalizace před inferencí (tj. žádný warmup, žádná adaptace, žádné chain diagnostics). 
...
Nakonec je třeba mít na paměti, že PFN musí být předem natrénovaný na konkrétním problému a s obrovským množstvím dat.
Např. pokud bychom chtěli aproximovat Gaussovský proces, je třeba PFN předem natrénovat na dostatečně velké rodině funkcí a pestrou distribucí parametrů/hyperparametrů.
