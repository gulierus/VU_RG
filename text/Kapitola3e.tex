...
Levý panel obrázku ukazuje MSE jako funkci $n$, pravý panel $\Delta$NLL.
Tečkovaná čára v pravém panelu značí \emph{oracle}, tedy nulu, ke které se chtějí všechny metody přiblížit.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/GP2_exp7_misspecification/fig_exp7_q1_mse_vs_n.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/GP2_exp7_misspecification/fig_exp7_q2_mse_vs_ls.png}
...
Její $\Delta$NLL zůstává malé i pro dvojnásobek horní hranice trénovacího rozdělení, žádný náhlý kolaps nenastává.
...
Z tabulky~\ref{tab:exp7_ood} může udělat jasné závěry.
...
Nejmenší je uprostřed rozsahu, kde model zřejmě viděl při tréninku nejvíce dat (těžiště rozdělení).
...
Z experimentu vyplývá, že sice degradace má místo být, ale na druhou stranu žádný náhlý kolaps nenastává.
\par
