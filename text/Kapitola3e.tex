...
Výsledky shrnují obrázek~\ref{fig:exp7_q1} a tabulky~\ref{tab:exp7_mse_n} a~\ref{tab:exp7_dnll_n}.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.65\linewidth]{figures/GP2_exp7_misspecification/fig_exp7_q1_mse_vs_n.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.576\linewidth]{figures/GP2_exp7_misspecification/fig_exp7_q2_mse_vs_ls.png}
...
Za krátkým okrajem rozsahu chyba prudce vzroste a poté se ustálí kolem hodnot $0{,}77$ až $0{,}79$, za dlouhým okrajem naopak opět klesá.
Pro velmi dlouhá $\ell$ jsou totiž realizace hladké a úloha je snadná i pro PFN, které takové délky při tréninku nevidělo.
...
Pro velmi krátké délky pod dolní hranicí je úloha těžká i pro samotný \emph{oracle}.
Je vidět, že kontext $40$ bodů rychlé oscilace jednoduše nezachytí.
