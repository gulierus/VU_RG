...
Nagler (2023) ukazuje, že pokud je trénovací loss NLL (negative log-likelihood, viz algoritmus~\ref{alg:nll_loss}) a model má dostatečnou kapacitu, optimální řešení konverguje k Bayesovskému posteriornímu prediktivnímu rozdělení. To znamená, že správně natrénovaný PFN je teoreticky ekvivalentní analytickému GP posterioru.
