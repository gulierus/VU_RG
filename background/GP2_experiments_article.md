...
|---|---|---|---|
| 1-layer | 0.00484 | 0.108 | bias² signifikantní |
| 2-layer | −0.00121 | 0.061 | nesignifikantní bias |
| 4-layer | −0.00098 | 0.039 | nesignifikantní bias |
| 6-layer | −0.00053 | 0.025 | nesignifikantní bias |
...
Jednovrstvý model má nenulové bias² = 0.00484 — konzistentní s tím, že jedna vrstva nestačí pro asymptotické přiblížení GP posterior. Od dvou vrstev výš je bias² statisticky nula; koeficient $c$ (variance term) klesá s hloubkou: $c_{1L}=0.108 > c_{2L}=0.061 > c_{4L}=0.039 > c_{6L}=0.025 \approx c_{8L}=0.026$.
...
|---|---|---|---|---|---|
| bias² (MSE dek.) | 0.00484 | −0.00121 | −0.00098 | −0.00053 | −0.00065 |
| c (variance term) | 0.108 | 0.061 | 0.039 | 0.025 | 0.026 |
